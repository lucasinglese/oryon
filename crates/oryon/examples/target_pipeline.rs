...
fn main() {
    ...
    let prices: Vec<Option<f64>> = vec![
        Some(100.0), Some(101.5), Some(103.0), Some(102.0), Some(104.5), Some(106.0),
        Some(105.5), Some(107.0), Some(109.0), Some(108.0), Some(110.0), Some(111.5),
    ];
    ...
    println!("{:<5} {:<8} {:<16} {:<14} {}", "bar", "close", "ctc_vol_3", "slope_4", "r2_4");
    for i in 0..n {
        println!("{:<5} {:<8.2} {:<16} {:<14} {}",
            i, prices[i].unwrap(),
            fmt(result[0][i]),
